...
function Sidebar({Employeekey}) {
  ...
  return (
    ...
    {/* sub header */}
    <div className='sub-header bg-blue-700'>
      <h1 className='text-3xl text-white p-4'>Elysium Payroll</h1>
    </div>

    {/* sections in sidebar */}
    <div className="hidden md:flex md:flex-shrink-0 p-4 my-8">
    ...
    <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
        ...
        <nav className="flex-1  bg-white space-y-1  ">
          ...
          <Link  to={'/admin/dashboard'} className="bg-indigo-50 text-indigo-600 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <svg className="text- mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <a href="#departments" className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <svg className="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* <!-- Payroll Processing --> */}
          <a href="#payroll" className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <svg className="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          {/* <!-- Reports & Analytics --> */}
          <a href="#reports" className="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
            <svg className="text-gray-400 group-hover:text-gray-500 mr-3 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
